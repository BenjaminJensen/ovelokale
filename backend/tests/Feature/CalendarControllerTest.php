...
test('returns ad-hoc bookings and parity-matching recurring slots for the requested week', function () {
    ...
    db()->exec("INSERT INTO recurring_slots (band_id, booked_by_user_id, day_of_week, start_time, end_time, week_parity, start_date)
        VALUES (3, 7, 3, '18:00:00', '20:00:00', 'even', '2020-01-01')");
...
test('returns a personal ad-hoc occurrence with a null band and the bookers name', function () {
    db()->exec("INSERT INTO bookings (band_id, start_time, end_time, booked_by_user_id)
...
test('returns a personal recurring occurrence with a null band and the bookers name', function () {
    db()->exec("INSERT INTO recurring_slots (band_id, booked_by_user_id, day_of_week, start_time, end_time, week_parity, start_date)
...
test('filtering by band_id excludes personal occurrences', function () {
    db()->exec("INSERT INTO bookings (band_id, start_time, end_time, booked_by_user_id)
        VALUES (NULL, '2026-09-09 19:00:00', '2026-09-09 21:00:00', 7)");
    db()->exec("INSERT INTO bookings (band_id, start_time, end_time, booked_by_user_id)
...
test('a recurring slot appears in a week within its start_date/end_date range', function () {
    db()->exec("INSERT INTO recurring_slots (band_id, booked_by_user_id, day_of_week, start_time, end_time, week_parity, start_date, end_date)
        VALUES (2, 7, 2, '18:00:00', '20:00:00', 'all', '2026-09-01', '2026-09-30')");
...
test('a recurring slot with no end_date continues to resolve indefinitely into the future', function () {
    db()->exec("INSERT INTO recurring_slots (band_id, booked_by_user_id, day_of_week, start_time, end_time, week_parity, start_date, end_date)
        VALUES (2, 7, 2, '18:00:00', '20:00:00', 'all', '2020-01-01', NULL)");
